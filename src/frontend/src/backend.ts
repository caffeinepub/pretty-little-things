...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async getAllLoginLogs(): Promise<Array<LoginLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLoginLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: Array<OrderItem>): Promise<Order> {
        if (this.processError) {
            try {
